...
/*
 ...
 Hierarchical  Inheritance: When we have several derived classes from a single base class, such an inheritance is termed hierarchical inheritance.
